...
for (t in taxons){
  ...
  model_ct %>% 
    layer_conv_2d(filters = 64, kernel_size = c(3, 3), data_format = "channels_last", padding = "valid", input_shape = inpt_shpe, activation = "relu") %>%
    #layer_average_pooling_2d(pool_size = c(2, 2)) %>%
    #layer_conv_2d(filters = 64, kernel_size = c(5, 5), data_format = "channels_last", padding = "valid", activation = "relu") %>%
    #layer_average_pooling_2d(pool_size = c(2, 2)) %>%
    #layer_conv_2d(filters = 32, kernel_size = c(1, 1), data_format = "channels_last", padding = "valid", input_shape = inpt_shpe, activation = "relu") %>%
  ...
  score_train
  #           loss             auc binary_accuracy 
  #     0.05936323      0.98458362      0.97900498 
  ...
  score #for test data
  #            loss             auc binary_accuracy 
  #      0.05092596      0.97424096      0.98340517
