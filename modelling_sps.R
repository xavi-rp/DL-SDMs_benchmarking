...
worldclim_all <- brick("worldclim_all_NoCor_070.tif")
...
occs_all <- fread("../virtualspecies/virtSp_occurrences.csv", header = TRUE)
...
for (t in taxons){
  ...
  #worldclim_all_data <- fread(paste0("worldclim_all_data.csv"), header = TRUE)
